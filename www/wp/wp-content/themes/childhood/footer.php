                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?= get_field_from_mainpage('contact_socials')['insta'] ?>" class="footer__social-item">
                            ...
                            <a href="<?= get_field_from_mainpage('contact_socials')['facebook'] ?>" class="footer__social-item">
                            ...
                            <a href="<?= get_field_from_mainpage('contact_socials')['youtube'] ?>" class="footer__social-item">
