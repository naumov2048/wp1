                    ...
                    <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                        <div class="header__contacts">
                            <div class="header__contacts-item">
                                <img src="<?= get_template_directory_uri() ?>/assets/img/icons/svg/email.svg" alt="почта" class="header__contacts-logo">
        ...
        <div class="mainslider glide">
            <div class="glide__track" data-glide-el="track">
                <ul class="glide__slides">
                    <li style="background-image: url('<?= get_template_directory_uri() ?>/assets/img/bg_1.jpg')" class="glide__slide">
                        <div class="container">
                            <div class="row">
                    ...
                    <li style="background-image: url('<?= get_template_directory_uri() ?>/assets/img/bg_2.jpg')" class="glide__slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                    ...
                    <li style="background-image: url('<?= get_template_directory_uri() ?>/assets/img/bg_3.jpg')" class="glide__slide">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-7 offset-1">
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1 col-lg-5 offset-lg-1">
                        <div class="about__img">
                            <img src="<?= get_template_directory_uri() ?>/assets/img/about.jpg" alt="про компанию">
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <img class="specialists__img" src="<?= get_template_directory_uri() ?>/assets/img/team.jpg" alt="наша команда">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="toys" id="toys">
            <div class="container">
                ...
                <div class="toys__wrapper">
                    ...
                    <div class="toys__item" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/toy_2.jpg)">
                        <div class="toys__item-info">
                    ...
                    <div class="toys__item" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/toy_3.jpg)">
                        <div class="toys__item-info">
                    ...
                    <div class="toys__item" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/toy_4.jpg)">
                        <div class="toys__item-info">
                    ...
                    <div class="toys__item" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/toy_5.jpg)">
                        <div class="toys__item-info">
                    ...
                    <div class="toys__item" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/toy_6.jpg)">
                        <div class="toys__item-info">
                ...
                <div class="toys__wrapper">
                    ...
                    <div class="toys__item" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/toy_7.jpg)">
                        <div class="toys__item-info">
                    ...
                    <div class="toys__item" style="background-image: url(<?= get_template_directory_uri() ?>/assets/img/toy_8.jpg)">
                        <div class="toys__item-info">
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?= get_template_directory_uri() ?>/assets/img/about_1.jpg" alt="мир детства">
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?= get_template_directory_uri() ?>/assets/img/about_2.jpg" alt="мир детства">
                    </div>
                    <div class="col-lg-6">
                        <div class="subtitle">
                            Главное - качество
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="aboutus__img" src="<?= get_template_directory_uri() ?>/assets/img/about_3.jpg" alt="мир детства">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-3">
                        <a href="#" class="footer__logo">
                            <img src="<?= get_template_directory_uri() ?>/assets/img/icons/svg/logo.svg" alt="мир детства" class="footer__logo-img">
                    ...
                    <div class="col-md-8 offset-md-0 col-lg-6 col-xl-5 offset-xl-1">
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                <img src="<?= get_template_directory_uri() ?>/assets/img/icons/svg/phone.svg" alt="телефон" class="footer__contacts-logo">
                            ...
                            <div class="footer__contacts-item">
                                <img src="<?= get_template_directory_uri() ?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="footer__contacts-logo">
                                <address>ул. Василисы Кожиной, 1<br>
                                    Москва, Россия, 121096</address>
                            </div>
                        </div>
